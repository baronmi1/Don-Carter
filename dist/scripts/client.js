 ...
 */ !(function (t) {
  ...
  function (t, e, n) {
    ...
    function ct(t) {
      ...
      e.active &&
        (e.eventListeners.forEach(st), t.dispatch((0, m.sessionStopped)()));
    }
    function st(t) {
      var e = t.target,
        n = t.listenerParams;
          ...
          if (p) {
            ...
            C({
              ...
              var E = S === e && 0 === p,
                ...
                m = M({ element: u, actionItem: t, elementApi: _ }, v);
              _t({
                store: n,
                element: u,
                actionItem: t,
      ...
      r.dispatch(
        ...
        f
          ...
          : (D({
            ...
            h && r.dispatch((0, m.instanceStarted)(g, T.tick)));
    }
    function yt(t, e) {
        ...
        switch (n.actionTypeId) {
          ...
          case ot:
            var c = r.getStyle,
              ...
              h = v.widthValue,
              m = v.heightValue;
            if (!g.IS_BROWSER_ENV) return { widthValue: h, heightValue: m };
            if (d === W) {
              var _ = c(e, L);
            ...
            if (p === W) {
              var y = c(e, M);
              s(e, M, ""), (m = f(e, "offsetHeight")), s(e, M, y);
            }
            return { widthValue: h, heightValue: m };
          case at:
          case ut:
          case ct:
            var I = n.config,
        ...
        i(r, M, {
          ...
          handler: function (t) {
            ...
            return (
              ...
              { elementHovered: S, clientX: h, clientY: m, pageX: y, pageY: b }
            );
          },
        }),
        i(r, W, {
...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        id: "634f65db6f66af7b2d853ff2|fec76f78-e671-8940-552c-8013fd4228ee",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-13": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|8fefcdd3-a569-45fc-48d5-45034d971ff1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-17": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|644b46dd-0e26-9662-c5b0-b28e174e8120",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-19": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|123a753d-ddc0-d49d-c440-531787d2958f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-21": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|5ae6eae6-892e-c1fd-4113-dd51701af1a0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-23": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|770ec202-39cc-f56c-1cbc-e540447e8200",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-25": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|86de3515-1fce-8da5-69a0-944ca5ad5f73",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-27": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|e7fa0276-4358-9504-2204-743a7f5ec318",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-29": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|87855aba-b31d-b0f4-2b33-86c3145d6f24",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-31": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|98c1540a-70b3-add1-7639-e2d0b4115194",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-33": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|9fa4f87e-136a-35b6-890f-16351b2984e4",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-35": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|9fa4f87e-136a-35b6-890f-16351b2984ec",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-37": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|9fa4f87e-136a-35b6-890f-16351b2984f4",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-39": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|9fa4f87e-136a-35b6-890f-16351b2984fc",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-41": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|9fa4f87e-136a-35b6-890f-16351b29850b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-43": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|10824cdb-9953-f2e3-8a6f-039a34954d94",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-45": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|10824cdb-9953-f2e3-8a6f-039a34954da0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-47": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|10824cdb-9953-f2e3-8a6f-039a34954da8",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-49": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|10824cdb-9953-f2e3-8a6f-039a34954db4",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-51": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|10824cdb-9953-f2e3-8a6f-039a34954dbc",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-53": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|d804fec9-1c3f-3ff3-b966-1aa3824e2aa2",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-55": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|27ae9d52-8c8a-6b69-ed8f-fda5af32324a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-57": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|27ae9d52-8c8a-6b69-ed8f-fda5af323252",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-59": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|27ae9d52-8c8a-6b69-ed8f-fda5af32325a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-67": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|0b4c97dc-5d48-e840-7468-22d4135ace7b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-69": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|0b4c97dc-5d48-e840-7468-22d4135ace87",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-71": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|0b4c97dc-5d48-e840-7468-22d4135ace8f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-73": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|0b4c97dc-5d48-e840-7468-22d4135ace97",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-75": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|0b4c97dc-5d48-e840-7468-22d4135ace9f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-81": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|fcf04413-1518-c699-7d50-bb022082ec31",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-83": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|ffb20ccf-0c72-c6d6-9537-29052a22596b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-85": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|17cf9bdf-3751-335d-1e1c-36b71c6f3a3d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-87": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|d67c7d2e-b281-02af-2bb8-6c4643c10e7e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-89": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|7e7d42ac-5b9d-e00f-35c4-c82f69facb7f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-91": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "634f65db6f66af7b2d853ff2|98314c13-1209-2eb5-6860-3a9b88e02fb7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: true,
                  id: "634f65db6f66af7b2d853ff2|0af49cae-4b55-a9c8-35fc-6fc3d3e422fb",
                },
                yValue: -380,
                xUnit: "DEG",
                yUnit: "deg",
